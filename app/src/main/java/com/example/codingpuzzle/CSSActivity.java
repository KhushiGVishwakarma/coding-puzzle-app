...
import com.example.codingpuzzle.databinding.ActivityCssBinding;
...
public class CSSActivity extends AppCompatActivity {
    ...
    private ActivityCssBinding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = ActivityCssBinding.inflate(getLayoutInflater());
    ...
    private void getDataFromFirebase() {
        FirebaseDatabase.getInstance().getReference("Questions/CSS/quizzes")
                .get()
