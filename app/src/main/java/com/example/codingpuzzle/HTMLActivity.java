...
import com.example.codingpuzzle.databinding.ActivityHtmlBinding;
...
public class HTMLActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = ActivityHtmlBinding.inflate(getLayoutInflater());
    ...
    private void getDataFromFirebase() {
        FirebaseDatabase.getInstance().getReference("Questions/HTML/quizzes")
                .get()
