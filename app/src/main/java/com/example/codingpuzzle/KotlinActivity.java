...
import com.example.codingpuzzle.databinding.ActivityKotlinBinding;
...
public class KotlinActivity extends AppCompatActivity {
    ...
    private ActivityKotlinBinding binding;
    ...
    private void getDataFromFirebase() {
        FirebaseDatabase.getInstance().getReference("Questions/Kotlin/quizzes")
                .get()
